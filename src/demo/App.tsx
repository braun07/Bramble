...
function App() {
  ...
  return (
    <>
      ...
      <div id="container" className="flex flex-col justify-center w-100 px-30 md:px-60 lg:px-120">
        <section id="home" className="flex w-100">
          <div className="xl:max-w-40 flex flex-col gap-60">
            ...
            <p className="fw-300 text-primary align-justify text-32 line-h-110">
            ...
            <div className="flex flex-col md:flex-row gap-20">
              <Button
                type="button"
                className="flex px-20 py-10 rounded-8 w-fit h-fit fw-300 text-24 xl:text-19 xxl:text-24 text-white bg-gradient-to-r from-bramble to-bramble-2"
              >
                View Components
              </Button>
              <Button
                type="button"
                className="flex px-20 py-9 rounded-8 w-fit h-fit fw-300 text-24 xl:text-19 xxl:text-24 text-white border-1 border-white border-solid"
              >
                Contact Us
              </Button>
            </div>
